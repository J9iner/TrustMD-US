// TrustMD Utah State Compliance Template
// Utah Department of Health and Division of Occupational and Professional Licensing compliance

class UtahComplianceTemplate {
    constructor() {
        this.template = {
            id: 'utah-state-v2024',
            name: 'Utah State Compliance',
            category: 'state',
            subcategory: 'ut',
            stateCode: 'UT',
            tier: 3,
            ...
            description: 'Utah Department of Commerce compliance',
            regulatoryReferences: [
                'Utah Code',
                'Utah Administrative Code',
                'Utah Prescription Drug Monitoring Program (PDMP)',
                'Utah Department of Commerce Regulations'
            ],
            sections: [
                {
                    ...
                    requirements: [
                        {
                            id: 'ut-license',
                            name: 'Utah Medical License',
                            description: 'Active Utah medical license',
                            mandatory: true,
                            evidenceRequired: ['UT medical license', 'License verification', 'Renewal documentation'],
                        ...
                        {
                            id: 'controlled-substance-ut',
                            name: 'Utah Controlled Substance Registration',
                            description: 'Utah controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['UT controlled substance registration', 'DEA registration', 'PDMP compliance'],
                            automatedChecks: ['ut_registration_current', 'dea_current', 'pdmp_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with UT professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'pdmp-checks',
                            name: 'Utah PDMP Checks',
                            description: 'Mandatory Utah PDMP checks before prescribing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Utah telemedicine practice requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Utah-specific opioid prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Utah-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Utah-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Utah medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Utah telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-ut',
                            name: 'Health Care Facility License',
                            description: 'Utah health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Utah facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and Utah accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Utah emergency preparedness requirements',
                            mandatory: true,
    ...
    // Get Utah-specific requirements
    getUtahSpecificRequirements() {
        return [
            'pdmp-checks',
            'telemedicine',
            'cme-utah',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = UtahComplianceTemplate;
} else {
    window.UtahComplianceTemplate = UtahComplianceTemplate;
}
