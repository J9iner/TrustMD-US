// TrustMD Oklahoma State Compliance Template
// Oklahoma State Board of Medical Licensure and Supervision and Department of Health compliance

class OklahomaComplianceTemplate {
    constructor() {
        this.template = {
            id: 'oklahoma-state-v2024',
            name: 'Oklahoma State Compliance',
            category: 'state',
            subcategory: 'ok',
            stateCode: 'OK',
            tier: 3,
            ...
            description: 'Oklahoma State Board of Medical Licensure compliance',
            regulatoryReferences: [
                'Oklahoma Statutes',
                'Oklahoma Administrative Code',
                'Oklahoma Prescription Drug Monitoring Program (PDMP)',
                'Oklahoma State Board of Medical Licensure Regulations'
            ],
            sections: [
                {
                    ...
                    requirements: [
                        {
                            id: 'ok-license',
                            name: 'Oklahoma Medical License',
                            description: 'Active Oklahoma medical license',
                            mandatory: true,
                            evidenceRequired: ['OK medical license', 'License verification', 'Renewal documentation'],
                        ...
                        {
                            id: 'cme-oklahoma',
                            name: 'Oklahoma CME Requirements',
                        ...
                        {
                            id: 'controlled-substance-ok',
                            name: 'Oklahoma Controlled Substance Registration',
                            description: 'Oklahoma controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['OK controlled substance registration', 'DEA registration', 'PDMP compliance'],
                            automatedChecks: ['ok_registration_current', 'dea_current', 'pdmp_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with OK professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'pdmp-checks',
                            name: 'Oklahoma PDMP Checks',
                            description: 'Mandatory Oklahoma PDMP checks before prescribing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oklahoma telemedicine practice requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oklahoma-specific opioid prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Oklahoma-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oklahoma-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oklahoma medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oklahoma telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-ok',
                            name: 'Health Care Facility License',
                            description: 'Oklahoma health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oklahoma facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and Oklahoma accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oklahoma emergency preparedness requirements',
                            mandatory: true,
    ...
    // Get Oklahoma-specific requirements
    getOklahomaSpecificRequirements() {
        return [
            'pdmp-checks',
            'telemedicine',
            'cme-oklahoma',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = OklahomaComplianceTemplate;
} else {
    window.OklahomaComplianceTemplate = OklahomaComplianceTemplate;
}
