// TrustMD Rhode Island State Compliance Template
// Rhode Island Department of Health and Board of Medical Licensure compliance

class RhodeIslandComplianceTemplate {
    constructor() {
        this.template = {
            id: 'rhode-island-state-v2024',
            name: 'Rhode Island State Compliance',
            category: 'state',
            subcategory: 'ri',
            stateCode: 'RI',
            tier: 4,
            ...
            description: 'Rhode Island Department of Health compliance',
            regulatoryReferences: [
                'Rhode Island General Laws',
                'Rhode Island Administrative Code',
                'Rhode Island Prescription Drug Monitoring Program (PDMP)',
            ...
            sections: [
                {
                    ...
                    requirements: [
                        {
                            id: 'ri-license',
                            name: 'Rhode Island Medical License',
                            description: 'Active Rhode Island medical license',
                            mandatory: true,
                            evidenceRequired: ['RI medical license', 'License verification', 'Renewal documentation'],
                        ...
                        {
                            id: 'cme-rhode-island',
                            name: 'Rhode Island CME Requirements',
                        ...
                        {
                            id: 'controlled-substance-ri',
                            name: 'Rhode Island Controlled Substance Registration',
                            description: 'Rhode Island controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['RI controlled substance registration', 'DEA registration', 'PDMP compliance'],
                            automatedChecks: ['ri_registration_current', 'dea_current', 'pdmp_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with RI professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'pdmp-checks',
                            name: 'Rhode Island PDMP Checks',
                            description: 'Mandatory Rhode Island PDMP checks before prescribing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Rhode Island license requirements for prescribing',
                            mandatory: true,
                            evidenceRequired: ['License requirements documentation', 'Prescribing authorization', 'Compliance records'],
                            automatedChecks: ['license_requirements_current', 'prescribing_authorized'],
                            riskLevel: 'high',
                            points: 15
                        },
                        {
                            ...
                            description: 'Rhode Island-specific prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Rhode Island-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Rhode Island-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Rhode Island medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Rhode Island telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-ri',
                            name: 'Health Care Facility License',
                            description: 'Rhode Island health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Rhode Island facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and Rhode Island accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Rhode Island emergency preparedness requirements',
                            mandatory: true,
            ...
            scoring: {
                ...
                automatedChecks: [
                    ...
                    'license_verified',
                    'cme_hours_met',
                    'ri_registration_current',
                    'dea_current',
                    'pdmp_compliant',
                    'pdmp_checked_before_prescribing',
                    'consent_documented',
                    'license_requirements_current',
                    'prescribing_authorized',
                    'guidelines_current',
    ...
    // Get Rhode Island-specific requirements
    getRhodeIslandSpecificRequirements() {
        return [
            'pdmp-checks',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = RhodeIslandComplianceTemplate;
} else {
    window.RhodeIslandComplianceTemplate = RhodeIslandComplianceTemplate;
}
