// TrustMD Oregon State Compliance Template
// Oregon Medical Board and Department of Human Services compliance

class OregonComplianceTemplate {
    constructor() {
        this.template = {
            id: 'oregon-state-v2024',
            name: 'Oregon State Compliance',
            category: 'state',
            subcategory: 'or',
            stateCode: 'OR',
            tier: 3,
            ...
            description: 'Oregon Board of Medical Examiners compliance',
            ...
            sections: [
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Active Oregon medical license',
                            mandatory: true,
                            evidenceRequired: ['OR medical license', 'License verification', 'Renewal documentation'],
                        ...
                        {
                            id: 'controlled-substance-or',
                            name: 'Oregon Controlled Substance Registration',
                            description: 'Oregon controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['OR controlled substance registration', 'DEA registration', 'PDMP compliance'],
                            automatedChecks: ['or_registration_current', 'dea_current', 'pdmp_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with OR professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'pdmp-checks',
                            name: 'Oregon PDMP Checks',
                            description: 'Mandatory Oregon PDMP checks before prescribing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            name: 'Death with Dignity Act Requirements',
                            description: 'Oregon Death with Dignity Act compliance requirements',
                            mandatory: true,
                            evidenceRequired: ['Death with Dignity training', 'Policy documentation', 'Patient education materials'],
                            automatedChecks: ['death_with_dignity_compliant', 'training_completed'],
                            riskLevel: 'high',
                            points: 15
                        },
                        {
                            ...
                            description: 'Oregon-specific opioid prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Oregon-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oregon-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oregon medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oregon telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-or',
                            name: 'Health Care Facility License',
                            description: 'Oregon health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oregon facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and Oregon accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Oregon emergency preparedness requirements',
                            mandatory: true,
            ...
            scoring: {
                ...
                automatedChecks: [
                    ...
                    'license_verified',
                    'cme_hours_met',
                    'or_registration_current',
                    'dea_current',
                    'pdmp_compliant',
                    'pdmp_checked_before_prescribing',
                    'consent_documented',
                    'death_with_dignity_compliant',
                    'training_completed',
                    'guidelines_current',
    ...
    // Get Oregon-specific requirements
    getOregonSpecificRequirements() {
        return [
            'pdmp-checks',
            'death-with-dignity',
            'cme-oregon',
    ...
    getPrescribingRequirements() {
        return {
            pdmpRequired: true,
            pdmpSystem: 'Oregon PDMP',
            deathWithDignity: true,
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = OregonComplianceTemplate;
} else {
    window.OregonComplianceTemplate = OregonComplianceTemplate;
}
