// TrustMD New Hampshire State Compliance Template
// New Hampshire Board of Medicine and Department of Health and Human Services compliance

class NewHampshireComplianceTemplate {
    constructor() {
        this.template = {
            id: 'new-hampshire-state-v2024',
            name: 'New Hampshire State Compliance',
            category: 'state',
            subcategory: 'nh',
            stateCode: 'NH',
            tier: 4,
            ...
            description: 'New Hampshire Board of Medicine compliance',
            regulatoryReferences: [
                'New Hampshire Revised Statutes',
                'New Hampshire Administrative Rules',
                'New Hampshire Prescription Drug Monitoring Program (PDMP)',
                'New Hampshire Board of Medicine Regulations'
            ],
            sections: [
                {
                    ...
                    requirements: [
                        {
                            id: 'nh-license',
                            name: 'New Hampshire Medical License',
                            description: 'Active New Hampshire medical license',
                            mandatory: true,
                            evidenceRequired: ['NH medical license', 'License verification', 'Renewal documentation'],
                            automatedChecks: ['license_current', 'license_verified'],
                            riskLevel: 'critical',
                            points: 20
                        },
                        {
                            id: 'cme-new-hampshire',
                            name: 'New Hampshire CME Requirements',
                        ...
                        {
                            id: 'controlled-substance-nh',
                            name: 'New Hampshire Controlled Substance Registration',
                            description: 'New Hampshire controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['NH controlled substance registration', 'DEA registration', 'PDMP compliance'],
                            automatedChecks: ['nh_registration_current', 'dea_current', 'pdmp_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with NH professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'pdmp-checks',
                            name: 'New Hampshire PDMP Checks',
                            description: 'Mandatory New Hampshire PDMP checks before prescribing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            name: 'Prescribing Requirements',
                            description: 'New Hampshire-specific prescribing requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'New Hampshire-specific opioid prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'New Hampshire-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'New Hampshire-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'New Hampshire medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'New Hampshire telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-nh',
                            name: 'Health Care Facility License',
                            description: 'New Hampshire health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'New Hampshire facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and New Hampshire accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'New Hampshire emergency preparedness requirements',
                            mandatory: true,
    ...
    // Get New Hampshire-specific requirements
    getNewHampshireSpecificRequirements() {
        return [
            'pdmp-checks',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = NewHampshireComplianceTemplate;
} else {
    window.NewHampshireComplianceTemplate = NewHampshireComplianceTemplate;
}
