// TrustMD Iowa State Compliance Template
// Iowa Board of Medicine and Department of Public Health compliance

class IowaComplianceTemplate {
    constructor() {
        this.template = {
            id: 'iowa-state-v2024',
            name: 'Iowa State Compliance',
            category: 'state',
            subcategory: 'ia',
            stateCode: 'IA',
            tier: 3,
            ...
            description: 'Iowa Board of Medicine compliance',
            regulatoryReferences: [
                'Iowa Code',
                'Iowa Administrative Code',
                'Iowa Prescription Drug Monitoring Program (PDMP)',
                'Iowa Board of Medicine Regulations'
            ],
            sections: [
                {
                    ...
                    requirements: [
                        {
                            id: 'ia-license',
                            name: 'Iowa Medical License',
                            description: 'Active Iowa medical license',
                            mandatory: true,
                            evidenceRequired: ['IA medical license', 'License verification', 'Renewal documentation'],
                        ...
                        {
                            id: 'controlled-substance-ia',
                            name: 'Iowa Controlled Substance Registration',
                            description: 'Iowa controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['IA controlled substance registration', 'DEA registration', 'PDMP compliance'],
                            automatedChecks: ['ia_registration_current', 'dea_current', 'pdmp_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with IA professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'pdmp-checks',
                            name: 'Iowa PDMP Checks',
                            description: 'Mandatory Iowa PDMP checks before prescribing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            name: 'Prescribing Requirements',
                            description: 'Iowa-specific prescribing requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Iowa-specific opioid prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Iowa-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Iowa-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Iowa medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Iowa telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-ia',
                            name: 'Health Care Facility License',
                            description: 'Iowa health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Iowa facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and Iowa accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Iowa emergency preparedness requirements',
                            mandatory: true,
    ...
    // Get Iowa-specific requirements
    getIowaSpecificRequirements() {
        return [
            'pdmp-checks',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = IowaComplianceTemplate;
} else {
    window.IowaComplianceTemplate = IowaComplianceTemplate;
}
