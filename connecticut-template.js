// TrustMD Connecticut State Compliance Template
// Connecticut Department of Public Health and Medical Examining Board compliance

class ConnecticutComplianceTemplate {
    constructor() {
        this.template = {
            id: 'connecticut-state-v2024',
            name: 'Connecticut State Compliance',
            category: 'state',
            subcategory: 'ct',
            stateCode: 'CT',
            tier: 3,
            ...
            description: 'Connecticut Department of Public Health compliance',
            regulatoryReferences: [
                'Connecticut General Statutes',
                'Connecticut Regulations',
                'Connecticut Prescription Drug Monitoring Program (PDMP)',
            ...
            sections: [
                {
                    ...
                    requirements: [
                        {
                            id: 'ct-license',
                            name: 'Connecticut Medical License',
                            description: 'Active Connecticut medical license',
                            mandatory: true,
                            evidenceRequired: ['CT medical license', 'License verification', 'Renewal documentation'],
                        ...
                        {
                            id: 'cme-connecticut',
                            name: 'Connecticut CME Requirements',
                        ...
                        {
                            id: 'controlled-substance-ct',
                            name: 'Connecticut Controlled Substance Registration',
                            description: 'Connecticut controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['CT controlled substance registration', 'DEA registration', 'PDMP compliance'],
                            automatedChecks: ['ct_registration_current', 'dea_current', 'pdmp_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with CT professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'pdmp-checks',
                            name: 'Connecticut PDMP Checks',
                            description: 'Mandatory Connecticut PDMP checks before prescribing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            name: 'Prescribing Requirements',
                            description: 'Connecticut-specific prescribing requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Connecticut-specific opioid prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Connecticut-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Connecticut-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Connecticut medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Connecticut telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-ct',
                            name: 'Health Care Facility License',
                            description: 'Connecticut health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Connecticut facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and Connecticut accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Connecticut emergency preparedness requirements',
                            mandatory: true,
    ...
    // Get Connecticut-specific requirements
    getConnecticutSpecificRequirements() {
        return [
            'pdmp-checks',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = ConnecticutComplianceTemplate;
} else {
    window.ConnecticutComplianceTemplate = ConnecticutComplianceTemplate;
}
