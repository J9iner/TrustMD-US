// TrustMD Minnesota State Compliance Template
// Minnesota Board of Medical Practice and Department of Health compliance

class MinnesotaComplianceTemplate {
    constructor() {
        this.template = {
            id: 'minnesota-state-v2024',
            name: 'Minnesota State Compliance',
            category: 'state',
            subcategory: 'mn',
            stateCode: 'MN',
            tier: 3,
            ...
            description: 'Minnesota Board of Medical Practice compliance',
            regulatoryReferences: [
                'Minnesota Statutes',
                'Minnesota Rules',
                'Minnesota Prescription Monitoring Program (PMP)',
                'Minnesota Board of Medical Practice Regulations'
            ],
            sections: [
                {
                    ...
                    requirements: [
                        {
                            id: 'mn-license',
                            name: 'Minnesota Medical License',
                            description: 'Active Minnesota medical license',
                            mandatory: true,
                            evidenceRequired: ['MN medical license', 'License verification', 'Renewal documentation'],
                        ...
                        {
                            id: 'cme-minnesota',
                            name: 'Minnesota CME Requirements',
                        ...
                        {
                            id: 'controlled-substance-mn',
                            name: 'Minnesota Controlled Substance Registration',
                            description: 'Minnesota controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['MN controlled substance registration', 'DEA registration', 'PMP compliance'],
                            automatedChecks: ['mn_registration_current', 'dea_current', 'pmp_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with MN professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'pmp-checks',
                            name: 'Minnesota PMP Checks',
                            description: 'Mandatory Minnesota PMP checks before prescribing',
                            mandatory: true,
                        ...
                        {
                            id: 'telehealth-regulations',
                            name: 'Telehealth Regulations',
                            description: 'Minnesota telehealth practice requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Minnesota-specific opioid prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Minnesota-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Minnesota-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Minnesota medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Minnesota telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-mn',
                            name: 'Health Care Facility License',
                            description: 'Minnesota health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Minnesota facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and Minnesota accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Minnesota emergency preparedness requirements',
                            mandatory: true,
    ...
    // Get Minnesota-specific requirements
    getMinnesotaSpecificRequirements() {
        return [
            'pmp-checks',
    ...
    getPrescribingRequirements() {
        return {
            pdmpRequired: true,
            pdmpSystem: 'Minnesota PMP',
            telehealthRegulations: true,
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = MinnesotaComplianceTemplate;
} else {
    window.MinnesotaComplianceTemplate = MinnesotaComplianceTemplate;
}
