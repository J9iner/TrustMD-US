// TrustMD North Carolina State Compliance Template
// North Carolina Medical Board and Department of Health and Human Services compliance

class NorthCarolinaComplianceTemplate {
    constructor() {
        this.template = {
            id: 'north-carolina-state-v2024',
            name: 'North Carolina State Compliance',
            category: 'state',
            subcategory: 'nc',
            stateCode: 'NC',
            tier: 2,
            ...
            description: 'North Carolina Medical Board and Department of Health and Human Services compliance',
            regulatoryReferences: [
                'North Carolina Medical Practice Act',
                'North Carolina Administrative Code',
                'North Carolina Controlled Substances Reporting System (NCCSRS)',
                'North Carolina Department of Health and Human Services Regulations'
            ],
            sections: [
                {
                    ...
                    requirements: [
                        {
                            id: 'nc-license',
                            name: 'North Carolina Medical License',
                            description: 'Active North Carolina medical license',
                            mandatory: true,
                            evidenceRequired: ['NC medical license', 'License verification', 'Renewal documentation'],
                            automatedChecks: ['license_current', 'license_verified'],
                            riskLevel: 'critical',
                            points: 20
                        },
                        {
                            id: 'cme-north-carolina',
                            name: 'North Carolina CME Requirements',
                            description: '150 CME hours every 3 years',
                            mandatory: true,
                        ...
                        {
                            id: 'controlled-substance-nc',
                            name: 'North Carolina Controlled Substance Registration',
                            description: 'North Carolina controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['NC controlled substance registration', 'DEA registration', 'NCCSRS compliance'],
                            automatedChecks: ['nc_registration_current', 'dea_current', 'nccsrs_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                            ...
                            description: 'Triennial license renewal requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with NC professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'nccsrs-checks',
                            name: 'North Carolina NCCSRS PDMP Checks',
                            description: 'Mandatory North Carolina NCCSRS checks before prescribing',
                            mandatory: true,
                            evidenceRequired: ['NCCSRS query logs', 'Patient consent forms', 'Query documentation'],
                            automatedChecks: ['nccsrs_checked_before_prescribing', 'consent_documented'],
                            riskLevel: 'critical',
                            points: 20
                        },
                        {
                            ...
                            description: 'North Carolina telehealth practice regulations',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'North Carolina-specific opioid prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'North Carolina-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'North Carolina-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'North Carolina medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'North Carolina telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-nc',
                            name: 'Health Care Facility License',
                            description: 'North Carolina health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'North Carolina facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and North Carolina accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'North Carolina emergency preparedness requirements',
                            mandatory: true,
            ...
            scoring: {
                ...
                automatedChecks: [
                    ...
                    'license_verified',
                    'cme_hours_met',
                    'nc_registration_current',
                    'dea_current',
                    'nccsrs_compliant',
                    'nccsrs_checked_before_prescribing',
                    'consent_documented',
    ...
    // Get North Carolina-specific requirements
    getNorthCarolinaSpecificRequirements() {
        return [
            'nccsrs-checks',
    ...
    getCMERequirements() {
        return {
            ...
            specificTopics: [
                'Medical Jurisprudence (30 hours)',
    ...
    getPrescribingRequirements() {
        return {
            pdmpRequired: true,
            pdmpSystem: 'North Carolina NCCSRS',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = NorthCarolinaComplianceTemplate;
} else {
    window.NorthCarolinaComplianceTemplate = NorthCarolinaComplianceTemplate;
}
