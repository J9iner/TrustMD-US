// TrustMD Georgia State Compliance Template
// Georgia Composite Medical Board and Department of Public Health compliance

class GeorgiaComplianceTemplate {
    constructor() {
        this.template = {
            id: 'georgia-state-v2024',
            name: 'Georgia State Compliance',
            category: 'state',
            subcategory: 'ga',
            stateCode: 'GA',
            tier: 2,
            ...
            description: 'Georgia Composite Medical Board and Department of Public Health compliance',
            ...
            sections: [
                {
                    ...
                    requirements: [
                        {
                            id: 'ga-license',
                            name: 'Georgia Medical License',
                            description: 'Active Georgia medical license',
                            mandatory: true,
                            evidenceRequired: ['GA medical license', 'License verification', 'Renewal documentation'],
                        ...
                        {
                            id: 'controlled-substance-ga',
                            name: 'Georgia Controlled Substance Registration',
                            description: 'Georgia controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['GA controlled substance registration', 'DEA registration', 'GA PDMP compliance'],
                            automatedChecks: ['ga_registration_current', 'dea_current', 'pdmp_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with GA professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'pdmp-checks',
                            name: 'Georgia PDMP Checks',
                            description: 'Mandatory Georgia PDMP checks before prescribing',
                            mandatory: true,
                        ...
                        {
                            id: 'pain-clinic-regulations',
                            name: 'Pain Clinic Regulations',
                            description: 'Georgia pain management clinic regulations',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Georgia-specific opioid prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Georgia-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Georgia-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Georgia medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Georgia telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-ga',
                            name: 'Health Care Facility License',
                            description: 'Georgia health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Georgia facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and Georgia accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Georgia emergency preparedness requirements',
                            mandatory: true,
    ...
    // Get Georgia-specific requirements
    getGeorgiaSpecificRequirements() {
        return [
            'pdmp-checks',
    ...
    getPrescribingRequirements() {
        return {
            pdmpRequired: true,
            pdmpSystem: 'Georgia PDMP',
            painClinicRegulations: true,
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = GeorgiaComplianceTemplate;
} else {
    window.GeorgiaComplianceTemplate = GeorgiaComplianceTemplate;
}
