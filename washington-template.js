// TrustMD Washington State Compliance Template
// Washington Medical Commission and Department of Health compliance

class WashingtonComplianceTemplate {
    constructor() {
        this.template = {
            id: 'washington-state-v2024',
            name: 'Washington State Compliance',
            category: 'state',
            subcategory: 'wa',
            stateCode: 'WA',
            tier: 2,
            ...
            description: 'Washington Medical Commission and Department of Health compliance',
            regulatoryReferences: [
                'Washington Revised Code',
                'Washington Administrative Code',
                'Washington Prescription Monitoring Program (PDMP)',
            ...
            sections: [
                {
                    ...
                    requirements: [
                        {
                            id: 'wa-license',
                            name: 'Washington Medical License',
                            description: 'Active Washington medical license',
                            mandatory: true,
                            evidenceRequired: ['WA medical license', 'License verification', 'Renewal documentation'],
                        ...
                        {
                            id: 'cme-washington',
                            name: 'Washington CME Requirements',
                            description: '200 CME hours every 4 years',
                            mandatory: true,
                        ...
                        {
                            id: 'controlled-substance-wa',
                            name: 'Washington Controlled Substance Registration',
                            description: 'Washington controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['WA controlled substance registration', 'DEA registration', 'PDMP compliance'],
                            automatedChecks: ['wa_registration_current', 'dea_current', 'pdmp_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with WA professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'pdmp-checks',
                            name: 'Washington PDMP Checks',
                            description: 'Mandatory Washington PDMP checks before prescribing',
                            mandatory: true,
                        ...
                        {
                            id: 'advanced-telemedicine',
                            name: 'Advanced Telemedicine Regulations',
                            description: 'Washington advanced telemedicine practice regulations',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Washington-specific opioid prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Washington-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Washington-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Washington medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Washington telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-wa',
                            name: 'Health Care Facility License',
                            description: 'Washington health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Washington facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and Washington accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Washington emergency preparedness requirements',
                            mandatory: true,
    ...
    // Get Washington-specific requirements
    getWashingtonSpecificRequirements() {
        return [
            'pdmp-checks',
    ...
    getCMERequirements() {
        return {
            ...
            specificTopics: [
                'Medical Jurisprudence (50 hours)',
                'Patient Safety (30 hours)',
                'Opioid Prescribing (20 hours)',
                'Controlled Substances (20 hours)',
                'Ethics (20 hours)',
                'Pain Management (20 hours)',
                'Infectious Diseases (20 hours)',
                'Domestic Violence (5 hours)',
                'Child Abuse Recognition (5 hours)',
                'Prescription Drug Monitoring (10 hours)',
                'Telemedicine (10 hours)',
                'End-of-Life Care (10 hours)',
                'Cultural Competency (10 hours)'
            ]
        };
    }
    ...
    getPrescribingRequirements() {
        return {
            pdmpRequired: true,
            pdmpSystem: 'Washington PDMP',
            advancedTelemedicine: true,
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = WashingtonComplianceTemplate;
} else {
    window.WashingtonComplianceTemplate = WashingtonComplianceTemplate;
}
