// TrustMD Maryland State Compliance Template
// Maryland Board of Physicians and Department of Health compliance

class MarylandComplianceTemplate {
    constructor() {
        this.template = {
            id: 'maryland-state-v2024',
            name: 'Maryland State Compliance',
            category: 'state',
            subcategory: 'md',
            stateCode: 'MD',
            tier: 2,
            ...
            description: 'Maryland Board of Physicians compliance',
            ...
            sections: [
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Active Maryland medical license',
                            mandatory: true,
                            evidenceRequired: ['MD medical license', 'License verification', 'Renewal documentation'],
                        ...
                        {
                            id: 'cme-maryland',
                            name: 'Maryland CME Requirements',
                        ...
                        {
                            id: 'controlled-substance-md',
                            name: 'Maryland Controlled Substance Registration',
                            description: 'Maryland controlled substance registration',
                            mandatory: true,
                            evidenceRequired: ['MD controlled substance registration', 'DEA registration', 'PDMP compliance'],
                            automatedChecks: ['md_registration_current', 'dea_current', 'pdmp_compliant'],
                            riskLevel: 'critical',
                            points: 15
                        },
                        {
                        ...
                        },
                        {
                            ...
                            description: 'Compliance with MD professional conduct standards',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'pdmp-checks',
                            name: 'Maryland PDMP Checks',
                            description: 'Mandatory Maryland PDMP checks before prescribing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Maryland medical marijuana program requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Maryland-specific opioid prescribing requirements',
                            mandatory: true,
                    ...
                    requirements: [
                        {
                            ...
                            description: 'Maryland-specific medical record documentation standards',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Maryland-specific consent requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Maryland medical record retention requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Maryland telehealth practice documentation requirements',
                            mandatory: true,
                ...
                },
                {
                    ...
                    requirements: [
                        {
                            id: 'facility-license-md',
                            name: 'Health Care Facility License',
                            description: 'Maryland health care facility licensing',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Maryland facility safety requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'ADA and Maryland accessibility requirements',
                            mandatory: true,
                        ...
                        },
                        {
                            ...
                            description: 'Maryland emergency preparedness requirements',
                            mandatory: true,
        ...
        for (const section of this.template.sections) {
            for (const requirement of section.requirements) {
                if (requirement.automatedChecks) {
                    checks.push(...requirement. requirements);
                }
            }
        }
    ...
    // Get Maryland-specific requirements
    getMarylandSpecificRequirements() {
        return [
            'pdmp-checks',
            'medical-marijuana',
            'cme-maryland',
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = MarylandComplianceTemplate;
} else {
    window.MarylandComplianceTemplate = MarylandComplianceTemplate;
}
